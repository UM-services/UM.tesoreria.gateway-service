...
def generate_wiki_content(wiki_dir: Path, data_dir: Path):
    ...
    try:
        ...
        with open(wiki_dir / 'Home.md', 'w', encoding='utf-8') as f:
            f.write("""# UM Tesorería Gateway Service

Bienvenido a la Wiki del Gateway Service de UM Tesorería.

## Propósito

El Gateway Service es el componente central de enrutamiento y control de acceso para la arquitectura de microservicios de UM Tesorería.
...
""")
        ...
        with open(wiki_dir / 'Milestones.md', 'w', encoding='utf-8') as f:
            f.write("# Milestones del Gateway Service\n\n")
        ...
        with open(wiki_dir / 'Issues-Activos.md', 'w', encoding='utf-8') as f:
            f.write("# Issues Activos - Gateway Service\n\n")
        ...
        with open(wiki_dir / 'Issues-Cerrados.md', 'w', encoding='utf-8') as f:
            f.write("# Issues Cerrados - Gateway Service\n\n")
        ...
        print(f"Error escribiendo archivos de la wiki del Gateway Service: {e}")
        return False
